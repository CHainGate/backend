...
func (s *UserApiService) CreateUsersWithArrayInput(ctx context.Context, user []openapi.User) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("CreateUsersWithArrayInput method not implemented")
}

// CreateUsersWithListInput - Creates list of users with given input array
func (s *UserApiService) CreateUsersWithListInput(ctx context.Context, user []openapi.User) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("CreateUsersWithListInput method not implemented")
}
...
func (s *UserApiService) GetUserByName(ctx context.Context, username string) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("GetUserByName method not implemented")
}

// LoginUser - Logs user into the system
func (s *UserApiService) LoginUser(ctx context.Context, username string, password string) (openapi.ImplResponse, error) {
