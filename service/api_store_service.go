...
func NewStoreApiService() openapi.StoreApiServicer {
	return &StoreApiService{}
}

// DeleteOrder - Delete purchase order by ID
func (s *StoreApiService) DeleteOrder(ctx context.Context, orderId string) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("DeleteOrder method not implemented")
}
...
func (s *StoreApiService) GetInventory(ctx context.Context) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("GetInventory method not implemented")
}
...
func (s *StoreApiService) GetOrderById(ctx context.Context, orderId int64) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("GetOrderById method not implemented")
}
...
func (s *StoreApiService) PlaceOrder(ctx context.Context, order openapi.Order) (openapi.ImplResponse, error) {
	...
	return openapi.Response(http.StatusNotImplemented, nil), errors.New("PlaceOrder method not implemented")
}
